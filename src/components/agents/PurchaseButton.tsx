...
export function PurchaseButton({
  ...
  return (
    <div>
      ...
      {/* Recurring-disclosure встроен в текст чекбокса "Согласен с офертой..."
          ниже — это удовлетворяет требованиям ЮКассы и ЦБ 822-П (явный show
          recurring условий ДО подтверждения покупки). Дублирующая плашка убрана
          по UX-решению. */}
      {isLoggedIn && (
