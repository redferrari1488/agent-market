...
export function CatalogTabs({
  ...
  return (
    <div className="mb-6 -mx-5 overflow-x-auto px-5 sm:mx-0 sm:px-0 [&::-webkit-scrollbar]:hidden">
      <div className="flex w-max items-center gap-1 border-b border-border/40 sm:w-auto">
        {visibleTabs.map((t) => {
          ...
          return (
            <button
              ...
              className={`relative inline-flex h-10 shrink-0 items-center gap-1.5 px-4 text-[13px] font-medium transition-colors ${
                active
                  ? "text-foreground"
