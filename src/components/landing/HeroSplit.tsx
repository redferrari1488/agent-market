...
const DEMO_AGENTS: CatalogAgent[] = [
  ...
  },
  {
    ...
    price: "5 900 ₽",
    desc: "Каждые 60 сек проверяет uptime и пишет в Slack.",
  },
  {
    id: "demo-4",
    slug: "support-bot",
    ...
    price: "1 900 ₽",
    desc: "Отвечает клиентам в Telegram круглосуточно — в твоём FAQ-стиле.",
  },
  {
    id: "demo-5",
    slug: "lead-qualifier",
    ...
    price: "12 400 ₽",
    desc: "Квалифицирует входящие, помечает горячих в CRM.",
  },
];
...
function HeroLeft() {
  return (
    ...
    >
      ...
      >
        Готовые AI-сотрудники для бизнеса: отвечают клиентам, пишут контент,
        следят за сайтом и собирают отчёты. Запуск за 5 минут - без
