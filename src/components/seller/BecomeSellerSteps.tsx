...
const STEPS = [
  {
    ...
    desc: "Расскажите про агента: функционал, демо, ссылку на ваш ресурс. Связываемся в Telegram, обсуждаем детали.",
  },
  {
    icon: ShieldCheck,
    title: "Согласование",
    desc: "Проверяем безопасность и качество. После одобрения открываем доступ к кабинету продавца.",
  },
  {
    icon: Wallet,
    title: "Получайте покупателей",
    desc: "Покупатели жмут «Перейти к продавцу» и попадают на ваш ресурс. Оплата и поставка — напрямую, без комиссий.",
  },
];
