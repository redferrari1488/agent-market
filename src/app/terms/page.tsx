      ...
      <div className="mt-8 space-y-6 text-sm text-muted-foreground">
        ...
        <section>
          ...
          <p>
            ...
            Платформа удерживает комиссию 12% с части продавца в каждой транзакции. Остальные
            88% перечисляются продавцу. Стоимость хостинга агента передаётся платформе как passthrough.
            Оплата возможна через YooKassa (₽) или Cryptomus (крипта).
          </p>
        </section>
