...
**Можно подавать заявку в ЮКассу-Самозанятый.** Реквизиты вписаны (ИНН 615520487706, Родимов А.Д.), юр.страницы под Gemini-модель, 6 публикуемых агентов с ценами в каталоге. Текст «Описание деятельности» — в `HANDOFF_2026-04-29.md` раздел 1.
